    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {designSystems.map((ds) => (
          ...
          >
            ...
            {ds.id === "shadcn" && (
              <span className="absolute -top-2 left-4 rounded-full bg-green-500 px-2 py-0.5 text-xs font-medium text-white">
                Populaire
              </span>
            )}
          </button>
      ...
      {selectedDesignSystem && (
        <div className="mt-8 rounded-xl border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800/50">
          ...
          <div className="flex items-center gap-2 rounded-lg bg-gray-900 p-3 font-mono text-sm text-green-400">
